...
<div class="easyui-layout" data-options="fit:true" style="height:100%; ">
    ...
    <div id="hrms-view" data-options="region:'center'"  style="background: #eaf6ff;" >
...
<script>
    ...
    //    var opts = $.fn.sidemenu.defaults;
    var opts = $.fn.dialog.defaults;
    console.log(opts);
    //    function toggle(){
...
<script>
    loadViewFromSideMenu($('#sm'),$('#hrms-view'));
</script>
